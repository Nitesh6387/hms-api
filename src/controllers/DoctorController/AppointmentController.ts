...
export const getDoctorAppointmentsController = async (req: any, res: any) => {
  try {
...
export const getDoctorAppointmentByIdController = async (req: any, res: any) => {
  try {
    const doctorId = req.user.id;
    const { id } = req.params;
...
export const updateAppointmentStatusByDoctorController = async (req: any, res: any) => {
  try {
    const doctorId = req.user.id;
    const { id } = req.params;
